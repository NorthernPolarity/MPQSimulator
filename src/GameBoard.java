...
public class GameBoard {
     ...
     */
    public MoveResults stabilizeGameBoard(){
    ...
    private void destroyTiles(MoveResults results){
        ...
        for (int i = 0; i < GameBoard.TILES_PER_ROW; i++){
            ...
            // On a plane and don't have access to internet and javadocs, make pretty later.
            Tile[] tilesToDestroy = new Tile[tileSet.size()];
            int tilePos = 0;
            for (Tile t : tileSet) {
                tilesToDestroy[tilePos] = t;
                tilePos++;
            }
            ...
            int tileToCopyIndex = emptyRowIndex + 1;
             ...
             // Array index
            int nextTileToBeDestroyedIndex = 1;
            ...
            while(tileToCopyIndex < TILES_PER_COL){
                ...
                if (nextTileToBeDestroyedIndex < tilesToDestroy.length
                       && tilesToDestroy[nextTileToBeDestroyedIndex].getCol() == tileToCopyIndex){
                    tileToCopyIndex++;
